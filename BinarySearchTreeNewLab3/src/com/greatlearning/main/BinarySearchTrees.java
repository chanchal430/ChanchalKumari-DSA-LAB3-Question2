...
public class BinarySearchTrees {
	...
	/*
	 * preOrder function. this function will be usable when we go through with
	 * traversing. bst.preorder() we have used only InOrder function to complete
	 * this code. This function can be skipped.
	 */
...
/*
 * postOrder function. this function will be usable when we go through with
 * traversing. bst.postorder(). we have used only InOrder function to complete
 * this code This function can be skipped.
 */
